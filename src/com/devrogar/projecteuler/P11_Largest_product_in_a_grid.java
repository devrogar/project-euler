...
public class P11_Largest_product_in_a_grid {
	...
	public static void main(String[] args) {
		P11_Largest_product_in_a_grid p11 = new P11_Largest_product_in_a_grid();
		System.out.print(p11.largestProduct(getGrid()));
	}
	...
	private void scanRows(int[][] grid) {
		int product = 0;
	...
	private void scanColumns(int[][] grid) {
		int product = 0;
